...
const adminController = new AdminController(photoRepo, userRepo, awardUseCase, forumRepo)
...
adminRouter.get('/users/search', adminController.listUsersWithSearch)
adminRouter.get('/users', adminController.listUsers)
adminRouter.get('/photos/pending', adminController.listPendingPhotos)
adminRouter.get('/photos', adminController.listAllPhotos)
adminRouter.get('/analytics', adminController.getAnalytics)
adminRouter.get('/activity', adminController.getActivity)
adminRouter.get('/forum/threads', adminController.listAllThreads)
adminRouter.delete('/forum/threads/:id', adminController.deleteThread)
adminRouter.delete('/forum/replies/:id', adminController.deleteReply)
