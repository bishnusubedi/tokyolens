...
export function ChampionHero({ award }: ChampionHeroProps) {
  if (!award) {
    return (
      <section className="relative h-[60vh] min-h-[400px] flex items-center justify-center bg-muted">
  ...
  return (
    <section className="relative h-[70vh] min-h-[480px] overflow-hidden">
      ...
      <div className="absolute top-4 left-4">
        <div className="flex items-center gap-2 bg-primary/90 text-primary-foreground px-3 py-1.5 rounded-full text-sm font-semibold">
      ...
      <div className="absolute bottom-0 left-0 right-0 p-6 md:p-10">
        <p className="text-white/70 text-sm font-medium tracking-widest uppercase mb-2">Weekly Champion</p>
